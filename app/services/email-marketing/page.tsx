...
const capabilities = [
  {
    ...
    href: "/services/email-marketing/email-strategy",
  },
  {
    number: "02",
    title: "Campaign Design",
    href: "/services/email-marketing/campaign-design",
  },
  {
    number: "03",
    title: "Newsletter Systems",
    href: "/services/email-marketing/newsletter-systems",
  },
  {
    number: "04",
    title: "Automation",
  ...
  },
  {
    ...
    href: "/services/email-marketing/lead-nurturing",
  },
  {
    number: "06",
    title: "Performance Optimisation",
    href: "/services/email-marketing/performance-optimisation",
  },
];
const journey = [
  "Attract",
...
const process = [
  {
    ...
    title: "Understand",
    description:
      "We learn about your audience, business goals, existing database and where email can create the most value.",
  },
  {
    number: "02",
    title: "Plan",
    description:
      "We create a communication strategy around the right audiences, messages, timing and customer journeys.",
  },
  {
    number: "03",
    title: "Create",
    description:
      "We develop clear, engaging email content and designs that feel connected to your wider brand.",
  },
  {
    number: "04",
    title: "Automate",
    description:
      "We identify opportunities to make useful communications happen automatically at the right moments.",
  },
  {
    number: "05",
    title: "Improve",
    description:
      "We use performance data to refine campaigns, messaging and journeys over time.",
  },
];
        ...
        <div className="mx-auto w-full max-w-[1600px]">
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              connected.
              <br />
              Stay relevant<span className="text-[#e21d2b]">.</span>
            </motion.h1>
          </div>
          ...
          >
            <p className="max-w-xl text-sm leading-6 text-white/55 sm:text-base">
              Email experiences that build relationships, keep your audience
              engaged and give people a reason to come back.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2rem,4vw,4.5rem)] font-medium leading-[1.02] tracking-[-0.045em] text-black/80">
                Email should feel like a useful conversation, not another
                interruption in someone's inbox.
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-black/50">
                We help businesses create email strategies and experiences
                that deliver relevant messages to the right people at the
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div>
              <h2 className="text-[clamp(4rem,8vw,8.5rem)] font-semibold uppercase leading-[0.78] tracking-[-0.07em]">
                ...
                sending
                <br />
                emails<span className="text-[#e21d2b]">.</span>
              </h2>

              <p className="mt-10 max-w-2xl text-base leading-7 text-white/45">
                Effective email marketing combines strategy, content,
                experience and timing. We bring those pieces together around
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2.4rem,5vw,5.5rem)] font-semibold uppercase leading-[0.88] tracking-[-0.06em]">
                ...
                Convert.
                <br />
                Retain<span className="text-[#e21d2b]">.</span>
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-black/50">
                Email can support the entire customer journey. The strongest
                programmes do not treat every subscriber the same — they
                respond to where each person is and what they need next.
              </p>
            </motion.div>
          </div>

          <div className="mt-16 grid gap-4 border-t border-black/15 pt-7 sm:grid-cols-2 lg:mt-24 lg:grid-cols-5">
            {journey.map((item, index) => (
              <div
                key={item}
                className="group flex items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-black/55"
              >
                <span className="flex h-7 w-7 items-center justify-center rounded-full border border-black/15 transition-colors group-hover:border-[#e21d2b] group-hover:text-[#e21d2b]">
                  0{index + 1}
                </span>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div>
              <h2 className="text-[clamp(4rem,8vw,8.5rem)] font-semibold uppercase leading-[0.78] tracking-[-0.07em]">
                ...
                to
                <br />
                relationship<span className="text-[#e21d2b]">.</span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2.4rem,5vw,5.5rem)] font-semibold uppercase leading-[0.88] tracking-[-0.06em]">
                ...
                Personal.
                <br />
                Measurable<span className="text-[#e21d2b]">.</span>
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-white/45">
                The goal is not to fill an inbox. It is to create useful
                communication that people choose to engage with and that gives
                the business something meaningful in return.
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-5 text-[clamp(2.5rem,5vw,5rem)] font-semibold uppercase leading-[0.85] tracking-[-0.06em]">
                Ready to build
                <br />
                better connections<span className="text-[#e21d2b]">?</span>
              </h2>
            </div>
