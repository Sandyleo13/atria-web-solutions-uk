...
const journey = [
  {
    ...
    title: "Discover",
    description:
      "We understand the problem, users, business objectives and the role the app needs to play.",
  },
  {
    number: "02",
    title: "Define",
    description:
      "We turn the initial idea into a focused product direction, defining features, priorities and the core user journeys.",
  },
  {
    number: "03",
    title: "Prototype",
    description:
      "We shape the experience before development so ideas can be tested, challenged and refined early.",
  },
  {
    number: "04",
    title: "Build",
    description:
      "We develop the product with usability, performance, reliability and future growth in mind.",
  },
  {
    number: "05",
    title: "Launch",
    description:
      "We test the experience across devices and prepare the product for a confident release.",
  },
  {
    number: "06",
    title: "Evolve",
    description:
      "A digital product is never really finished. We use feedback and real-world behaviour to identify what comes next.",
  },
];
        ...
        <div className="mx-auto w-full max-w-[1600px]">
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              something
              <br />
              people use<span className="text-[#e21d2b]">.</span>
            </motion.h1>
          </div>
          ...
          >
            <p className="max-w-xl text-sm leading-6 text-white/55 sm:text-base">
              Mobile products designed around real user behaviour, built for
              performance and created to evolve with the business.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2rem,4vw,4.5rem)] font-medium leading-[1.02] tracking-[-0.045em] text-black/80">
                A great app should make something easier, faster or better for
                the people using it.
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-black/50">
                We help businesses turn ideas into useful mobile experiences,
                from early product concepts and MVPs through to established
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div>
              <h2 className="text-[clamp(4rem,8vw,8.5rem)] font-semibold uppercase leading-[0.78] tracking-[-0.07em]">
                ...
                with a
                <br />
                purpose<span className="text-[#e21d2b]">.</span>
              </h2>

              <p className="mt-10 max-w-2xl text-base leading-7 text-white/45">
                We don't build features simply because they can be built. We
                focus on the product experience, the user and the problem the
                technology is there to solve.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2.4rem,5vw,5.5rem)] font-semibold uppercase leading-[0.88] tracking-[-0.06em]">
                ...
                follows the
                <br />
                experience<span className="text-[#e21d2b]">.</span>
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-black/50">
                The best technology decision is not always the most complicated
                one. We start with the experience we want to create and then
                choose the right technical approach to support it.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div>
              <h2 className="text-[clamp(4rem,8vw,8.5rem)] font-semibold uppercase leading-[0.78] tracking-[-0.07em]">
                ...
                to
                <br />
                product<span className="text-[#e21d2b]">.</span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-5xl text-[clamp(2.4rem,5vw,5.5rem)] font-semibold uppercase leading-[0.88] tracking-[-0.06em]">
                ...
                Fast.
                <br />
                Scalable<span className="text-[#e21d2b]">.</span>
              </p>

              <p className="mt-10 max-w-2xl text-base leading-7 text-white/45">
                A successful mobile product should fit naturally into people's
                lives while giving the business a strong foundation for what
                comes next.
              </p>
            </motion.div>
          </div>
