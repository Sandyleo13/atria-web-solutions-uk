        ...
        <div className="mx-auto w-full max-w-[1600px]">
          ...
          <div className="overflow-hidden">
            <motion.h1
              ...
              className="max-w-3xl text-[clamp(2rem,5vw,5.5rem)] font-semibold uppercase leading-[0.74] tracking-[-0.08em]"
            >
              Do work
              <br />
              that
          ...
          >
            ...
            <motion.a
              ...
              className="hidden items-center gap-3 text-[9px] uppercase tracking-[0.3em] text-white/30 transition-colors hover:text-white sm:flex"
            >
              Explore
      ...
      <section id="intro" className="px-6 py-28 sm:px-10 sm:py-36 lg:px-14 lg:py-44">
        <div className="mx-auto max-w-[1600px]">
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="max-w-3xl text-[clamp(2rem,5vw,5.5rem)] font-medium leading-[1] tracking-[-0.05em] text-black/80">
        ...
        <div className="mx-auto max-w-[1600px]">
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div>
              ...
              <p className="mt-10 max-w-2xl text-sx leading-7 text-white/40">
        ...
        <div className="mx-auto max-w-[1600px]">
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-[clamp(2rem,5vw,5.5rem)] font-semibold uppercase leading-[0.8] tracking-[-0.07em]">
                We may still
                <br />
                want to meet
                <br />
              ...
              <p className="mt-10 max-w-2xl text-sx leading-7 text-black/50">
              ...
              <Link
                href="/contact"
                className="group mt-10 flex w-fit items-center gap-4 text-[14px] font-semibold uppercase tracking-[0.25em]"
              >
                Send your details
        ...
        <div className="mx-auto max-w-[1600px] border-t border-black/15 pt-7">
          <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-5 text-[clamp(2rem,5vw,5.5rem)] font-semibold uppercase leading-[0.85] tracking-[-0.06em]">
                Let's make
                <br />
