  ...
  return (
    <main className="overflow-hidden bg-[#f4f2ed]">
      ...
      <section className="relative flex min-h-screen items-end overflow-hidden bg-[#0a0a0a] px-6 pb-20 pt-32 text-white sm:px-10 sm:pb-24 lg:px-14 lg:pb-28">
        ...
        <div className="pointer-events-none absolute right-[-10%] top-[15%] h-[500px] w-[500px] rounded-full bg-[#e21d2b]/10 blur-[140px]" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1600px]">
          ...
          <motion.h1
            ...
            className="max-w-[1450px] text-[clamp(5rem,12vw,13rem)] font-semibold uppercase leading-[0.72] tracking-[-0.085em]"
          >
            {industry.title}
              ...
              <div className="mt-20 grid gap-px overflow-hidden border border-black/10 bg-black/10 sm:grid-cols-2">
                ...
                {industry.approach.map((item, index) => (
                  <motion.article
                    ...
                    className="min-h-[300px] bg-[#e9e6df] p-8 sm:p-10"
                  >
